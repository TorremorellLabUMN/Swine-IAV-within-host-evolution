...
if "PB2" in name:
    ...
    for order in range(0,len(Annotate),1):
        ...
        if str(Amino_mutation[0]) != str(Amino_mutation[-1]):
            ...
            if amino_site > 0 and amino_site < 36 and amino_site != 28:
            ...
            elif amino_site > 483 and amino_site < 497 and amino_site!=495:
               Functional_relevant.append("Yes") 
            ...
            elif amino_site > 319 and amino_site < 448 and amino_site!=361 and amino_site!=376 and amino_site!=339 and amino_site != 368 and amino_site != 391 and amino_site != 447:
               Functional_relevant.append("Yes")
            ...
            elif amino_site > 447 and amino_site < 484 and amino_site != 477:
               Functional_relevant.append("Yes")
...
if "PB1" in name:               
   ...
   for order in range(0,len(Annotate),1):
        ...
        if Amino_mutation_S == "NA":
           Functional_relevant_S.append("No")
           Feature_S.append("NA")
           Comment_S.append("NA")
           Reference_S.append("NA")  
        
        if str(Amino_mutation[0]) != str(Amino_mutation[-1]) and Amino_mutation != "NA":
           amino_site=int(Amino_mutation[1:-1])
           ...
           elif amino_site > 202 and amino_site < 217 and amino_site != 207:
              Functional_relevant.append("Yes")
        ...
        if str(Amino_mutation_S[0]) != str(Amino_mutation_S[-1]) and Amino_mutation_S != "NA":
