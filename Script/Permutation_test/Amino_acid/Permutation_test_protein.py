...
H1_Prime_boost= permutation_test(Prime_boost_H1, Nucleotide_region_H1, stimulation)
...
H3_Prime_boost= permutation_test(Prime_boost_H3, Nucleotide_region_H3, stimulation)
# run the method for 70% amino acid sites.
stimulation = 100000

H1_70_LAIV_NONE= permutation_test(LAIV_NONE_H1, Nucleotide_region_70_H1, stimulation)    
H1_70_Prime_boost= permutation_test(Prime_boost_H1, Nucleotide_region_70_H1, stimulation)
...
H3_70_Prime_boost= permutation_test(Prime_boost_H3, Nucleotide_region_70_H3, stimulation)
...
df_H1_Prime_boost = pd.DataFrame({"whole_genome":H1_Prime_boost})
df_H1_Prime_boost = df_H1_Prime_boost.reset_index()
df_H1_Prime_boost ["Group"]= "Prime_boost"  

df_H1_protein=pd.concat([df_H1_LAIV_NONE,df_H1_NO_VAC,df_H1_Prime_boost])
#H3 convert dataset.
...
df_H3_Prime_boost = pd.DataFrame({"whole_genome":H3_Prime_boost})
df_H3_Prime_boost = df_H3_Prime_boost.reset_index()
df_H3_Prime_boost ["Group"]= "Prime_boost"
df_H3_NO_VAC = pd.DataFrame({"whole_genome":H3_NO_VAC})
df_H3_NO_VAC = df_H3_NO_VAC.reset_index()
df_H3_NO_VAC ["Group"]= "NO_VAC"

df_H3_protein=pd.concat([df_H3_Prime_boost,df_H3_LAIV_NONE,df_H3_NO_VAC])
...
df_H1_70_Prime_boost = pd.DataFrame({"whole_genome":H1_70_Prime_boost})
df_H1_70_Prime_boost = df_H1_70_Prime_boost.reset_index()
df_H1_70_Prime_boost ["Group"]= "Prime_boost" 

df_H1_70_protein=pd.concat([df_H1_70_LAIV_NONE,df_H1_70_NO_VAC,df_H1_70_Prime_boost])
...
df_H3_70_Prime_boost = pd.DataFrame({"whole_genome":H3_70_Prime_boost})
df_H3_70_Prime_boost = df_H3_70_Prime_boost.reset_index()
df_H3_70_Prime_boost ["Group"]= "Prime_boost"
...
df_H3_70_protein=pd.concat([df_H3_70_Prime_boost,df_H3_70_LAIV_NONE,df_H3_70_NO_VAC])
